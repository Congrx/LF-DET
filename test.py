...
def main(args):
    ...
    with torch.no_grad():
        ...
        for index, test_name in enumerate(test_Names):
            ...
            psnr_iter_test, ssim_iter_test, LF_name,psnr_iter_test_allviews,ssim_iter_test_allviews = test(test_loader, device, net, save_dir)
            excel_file.write_sheet(test_name, LF_name, psnr_iter_test, ssim_iter_test)
            excel_file_allviews.write_sheet(test_name, LF_name, psnr_iter_test, ssim_iter_test,psnr_iter_test_allviews,ssim_iter_test_allviews)
